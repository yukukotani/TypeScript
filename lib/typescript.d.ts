...
declare namespace ts {
    ...
    enum SyntaxKind {
        ...
        NumberKeyword = 151,
        ObjectKeyword = 152,
        SatisfiesKeyword = 153,
        SetKeyword = 154,
        StringKeyword = 155,
        SymbolKeyword = 156,
        TypeKeyword = 157,
        UndefinedKeyword = 158,
        UniqueKeyword = 159,
        UnknownKeyword = 160,
        UsingKeyword = 161,
        FromKeyword = 162,
        ...
        ImportAttribute = 303,
        /** @deprecated */ AssertClause = 302,
        /** @deprecated */ AssertEntry = 303,
        /** @deprecated */ ImportTypeAssertionContainer = 304,
        ...
        FirstReservedWord = 84,
        LastReservedWord = 119,
        FirstKeyword = 84,
        LastKeyword = 166,
        FirstFutureReservedWord = 120,
        LastFutureReservedWord = 128,
        FirstTypeNode = 183,
        LastTypeNode = 206,
        FirstPunctuation = 19,
        LastPunctuation = 80,
    ...
    interface CallThisExpression extends MemberExpression, LeftHandSideExpression, Declaration {
    ...
    type CallLikeExpression = CallExpression | NewExpression | CallThisExpression | TaggedTemplateExpression | Decorator | JsxOpeningLikeElement | InstanceofExpression;
    ...
    function isCallThisExpression(node: Node): node is CallThisExpression;
