...
export class ProjectService {
    ...
    private pendingOpenFileProjectUpdates = new Map<Path, ConfigFileNameOrMap>();
    /** @internal */
    ...
    private onConfigFileChanged(configFileName: NormalizedPath, canonicalConfigFilePath: NormalizedPath, eventKind: FileWatcherEventKind) {
        ...
        configFileExistenceInfo?.openFilesImpactedByConfigFile?.forEach((_infoIsRootOfInferredProject, path) => {
            ...
            if (configFileNameForInfo) {
                ...
                if (!this.pendingOpenFileProjectUpdates.has(path)) this.pendingOpenFileProjectUpdates.set(path, existingValue);
            }
        });
        this.delayEnsureProjectForOpenFiles();
    }
    ...
    reloadProjects() {
        ...
        this.pendingOpenFileProjectUpdates.clear();
    ...
    private ensureProjectForOpenFiles() {
        ...
        const pendingOpenFileProjectUpdates = arrayFrom(this.pendingOpenFileProjectUpdates.keys());
        this.pendingOpenFileProjectUpdates.clear();
