...
Info seq  [hh:mm:ss:mss] New unresolvedImports for /users/username/projects/project/foo.ts:: ["bar"]
Info seq  [hh:mm:ss:mss] Calculating unresolved imports list of program:: Files:: 1 Done: ["bar"]
Info seq  [hh:mm:ss:mss] Project '/dev/null/inferredProject1*' (Inferred)
Info seq  [hh:mm:ss:mss] 	Files (1)
...
Info seq  [hh:mm:ss:mss] New unresolvedImports for /users/username/projects/project/bar.d.ts:: []
Info seq  [hh:mm:ss:mss] New unresolvedImports for /users/username/projects/project/foo.ts:: []
