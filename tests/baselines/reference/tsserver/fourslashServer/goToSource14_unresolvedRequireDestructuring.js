...
Info seq  [hh:mm:ss:mss] New unresolvedImports for /index.js:: ["unresolved"]
Info seq  [hh:mm:ss:mss] Calculating unresolved imports list of program:: Files:: 4 Done: ["unresolved"]
Info seq  [hh:mm:ss:mss] Project '/dev/null/inferredProject1*' (Inferred)
Info seq  [hh:mm:ss:mss] 	Files (4)
