...
Info seq  [hh:mm:ss:mss] New unresolvedImports for /users/username/projects/project/b.ts:: []
Info seq  [hh:mm:ss:mss] New unresolvedImports for /users/username/projects/project/sub/a.ts:: []
...
Info seq  [hh:mm:ss:mss] -----------------------------------------------
Info seq  [hh:mm:ss:mss] Calculating unresolved imports list of program:: Files:: 3
Info seq  [hh:mm:ss:mss] New unresolvedImports for /users/username/projects/project/a.ts:: []
Info seq  [hh:mm:ss:mss] Calculating unresolved imports list of program:: Files:: 3 Done: []
Info seq  [hh:mm:ss:mss] Project '/users/username/projects/project/tsconfig.json' (Configured)
Info seq  [hh:mm:ss:mss] 	Files (3)
