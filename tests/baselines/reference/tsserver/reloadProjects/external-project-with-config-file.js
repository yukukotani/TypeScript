...
Info seq  [hh:mm:ss:mss] New unresolvedImports for /user/username/projects/myproject/file2.ts:: []
Info seq  [hh:mm:ss:mss] New unresolvedImports for /user/username/projects/myproject/file1.ts:: ["module1"]
Info seq  [hh:mm:ss:mss] Calculating unresolved imports list of program:: Files:: 3 Done: ["module1"]
Info seq  [hh:mm:ss:mss] event:
    {
      "seq": 0,
      "type": "event",
...
Info seq  [hh:mm:ss:mss] New unresolvedImports for /user/username/projects/myproject/node_modules/module1/index.d.ts:: []
Info seq  [hh:mm:ss:mss] New unresolvedImports for /user/username/projects/myproject/file1.ts:: []
