...
Info seq  [hh:mm:ss:mss] New unresolvedImports for /user/username/projects/myproject/src/somefolder/module1.ts:: []
Info seq  [hh:mm:ss:mss] New unresolvedImports for /user/username/projects/myproject/src/somefolder/srcfile.ts:: ["somefolder"]
Info seq  [hh:mm:ss:mss] New unresolvedImports for /user/username/projects/myproject/src/typings/electron.d.ts:: []
Info seq  [hh:mm:ss:mss] New unresolvedImports for /user/username/projects/myproject/src/typings/node.d.ts:: []
Info seq  [hh:mm:ss:mss] Calculating unresolved imports list of program:: Files:: 5 Done: ["somefolder"]
Info seq  [hh:mm:ss:mss] event:
    {
      "seq": 0,
      "type": "event",
