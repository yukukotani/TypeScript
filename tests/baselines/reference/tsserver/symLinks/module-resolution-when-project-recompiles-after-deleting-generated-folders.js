...
Info seq  [hh:mm:ss:mss] New unresolvedImports for /users/username/projects/myproject/javascript/packages/recognizers-text/dist/types/recognizers-text.d.ts:: []
Info seq  [hh:mm:ss:mss] New unresolvedImports for /users/username/projects/myproject/javascript/packages/recognizers-date-time/src/datetime/basedate.ts:: []
...
Info seq  [hh:mm:ss:mss] New unresolvedImports for /users/username/projects/myproject/javascript/packages/recognizers-date-time/src/datetime/basedate.ts:: ["@microsoft/recognizers-text"]
Info seq  [hh:mm:ss:mss] Calculating unresolved imports list of program:: Files:: 2 Done: ["@microsoft/recognizers-text"]
