...
Info seq  [hh:mm:ss:mss] New unresolvedImports for /packages/app/src/index.ts:: ["dep"]
Info seq  [hh:mm:ss:mss] Calculating unresolved imports list of program:: Files:: 1 Done: ["dep"]
Info seq  [hh:mm:ss:mss] event:
    {
      "seq": 0,
      "type": "event",
